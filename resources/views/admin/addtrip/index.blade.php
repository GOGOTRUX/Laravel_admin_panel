							            	...
							            	<div class="row detail-box">
												<!-- dropdown  -->
														...
														<div class="form-group">
															<label class="cities">Select city:</label>
											...
											<!-- end  -->
							            		<div class="col-md-6">
													<div class="form-group">
														...
														<input type="hidden" name="book_op_id" id="book_op_id" class="form-control" value="{{ session('bookPartnerId')[0] ?? '' }} "/>
																...
																<div>
																	...
																	<div class="row">
																		<div class="form-group col-l-half">
        																	...
        																	<input type="text" id="autopick" name="start_address_line_1" class="search-outer form-control as-input" value="{{ Session::has('editTripData') ? session('editTripData')[0]->start_address_line_1 : ''}}" placeholder="Search places or eLoc's..." required="" spellcheck="false">
				            		...
				            		<div class="col-sm-7 brd-1 p-0">
				            			<div class="row">
						            			...
						            			<div class="selected-mt">
							            			<div class="mt-info" id="mt-info">
														@if (Session::has('editTripIsSaved') || Session::has('editTripIsBooked'))
															...
															<input type="hidden" id="notiId" name="notiId" value="{{ session('editTripData')[0]->trip_notification_id }}">
															<input type="hidden" id="tripId" name="tripId" value="{{ session('editTripData')[0]->trip_transaction_id }}">
						            		...
						            		<div class="col-md-8 pay-info">
						            			...
						            			<div class="row">
													<div class="col-sm-6 form-group">
														<input class="form-control" type="text" id="gstn"  name="gstn" value="{{ session('editTripData')[0]->gstn ?? ''}}"  
														"@if(!empty( session('editTripData')[0]->gstn))
                                        					readonly
                                    					@endif"
														/> 
					            						<label>GSTN</label>
				...
				success : function(data){
					...
					var interval = setInterval(() => {
						...
						if(timesRun === 120){
							...
							timeout = setTimeout(loaded, 1500);
							swal({
								title: 'Selected GOGOTRUX Is Not Available. Please Try Another Vehicle.',
								type: 'warning',
						...
						// if(data == null){	
							...
							// var booking_status = "Trip Accepted";
							// var notificationId = 1050;
